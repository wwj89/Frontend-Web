<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="Nick Name" prop="nickName" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    cancelAuthUser(row) {
      ...
      this.$confirm('Are you sure you want to cancel the user\'s role ' + row.userName + ' ？', 'System prompt', {
    ...
    cancelAuthUserAll(row) {
      ...
      this.$confirm('Do you want to deselect the user authorization data item?', 'System prompt', {
          confirmButtonText: 'OK',
          cancelButtonText: 'Cancel '
        }
      ).then(function() {
