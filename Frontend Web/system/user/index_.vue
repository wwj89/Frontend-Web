  ...
  <div class="app-container">
          ...
          >
            <template slot-scope="scope" v-if="scope.row.userId !== 1">
              ...
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:user:resetPwd', 'system:user:edit']">
                <el-button size="mini" type="text" icon="el-icon-d-arrow-right">Other</el-button>
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleResetPwd" icon="el-icon-key"
                    v-hasPermi="['system:user:resetPwd']">Reset Password</el-dropdown-item>
                  <el-dropdown-item command="handleAuthRole" icon="el-icon-circle-check"
                    v-hasPermi="['system:user:edit']">Allot Role</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="Nick Name" prop="nickName">
              <el-input v-model="form.nickName" placeholder="Please enter a user nickname" maxlength="30" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="Phone" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="Please enter your mobile number" maxlength="11" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitForm">Cofirm</el-button>
...
export default {
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$confirm('Are you sure you want to ' + text + row.roleName + ' ？', 'System prompt', {
        ...
        if (valid) {
          if (this.form.userId != undefined) {
            ...
            addUser(this.form).then(response => {
              this.$modal.msgSuccess("news successfully");
              this.open = false;
              this.getList();
            });
          }
