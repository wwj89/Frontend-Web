...
<!--                <li>Deletefuse无效选项maxPatternLength</li>-->
...
<!--                <li>Delete多余的salt字段</li>-->
<!--                <li>Add获取不带后缀文件名称方法</li>-->
<!--                <li>Add获取配置文件中的属性值方法</li>-->
<!--                <li>Add内容编码/解码方便插件集成使用</li>-->
<!--                <li>-->
...
<!--              <ol>-->
<!--                <li>AddVue3前端代码生成模板</li>-->
<!--                <li>Add图片预览组件</li>-->
<!--                <li>Add压缩插件实现打包Gzip</li>-->
<!--                <li>自定义xss校验注解实现</li>-->
<!--                <li>自定义文字复制剪贴指令</li>-->
<!--                <li>代码生成预览支持复制内容</li>-->
...
<!--              <ol>-->
<!--                <li>Add配套并同步的Vue3前端版本</li>-->
<!--                <li>Add通用方法简化模态/缓存/下载/权限/页签使用</li>-->
<!--                <li>优化导出数据/使用通用下载方法</li>-->
<!--                <li>Excel注解支持自定义数据处理器</li>-->
<!--                <li>Excel注解支持导入导出标题信息</li>-->
<!--                <li>Excel导入支持@Excels注解</li>-->
<!--                <li>Add组件data-dict，简化数据字典使用</li>-->
<!--                <li>AddJaxb依赖，防止jdk8以上出现的兼容错误</li>-->
...
<!--                <li>修复生成树表代码异常</li>-->
<!--                <li>Updateip字段长度防止ipv6地址长度不够</li>-->
...
<!--                <li>回显数据字典防止空值报错</li>-->
<!--                <li>日志记录增加过滤多文件场景</li>-->
<!--                <li>Update缓存Set方法可能导致嵌套的问题</li>-->
<!--                <li>移除前端一些多余的依赖</li>-->
<!--                <li>防止安全扫描YUI出现的风险提示</li>-->
<!--                <li>Updatenode-sass为dart-sass</li>-->
...
<!--                <li>Updatesass为node-sass，避免el-icon图标乱码</li>-->
<!--                <li>代码生成支持同步数据库</li>-->
<!--                <li>代码生成支持富文本控件</li>-->
...
<!--                <li>Update node-sass 为 dart-sass</li>-->
...
<!--                <li>Update用户管理复选框宽度，防止部分浏览器出现省略号</li>-->
...
<!--              <ol>-->
<!--                <li>Add代码生成</li>-->
<!--                <li>Add@RepeatSubmit注解，防止重复提交</li>-->
<!--                <li>Add菜单主目录添加/删除操作</li>-->
<!--                <li>日志记录过滤特殊对象，防止转换异常</li>-->
<!--                <li>Update代码生成路由脚本错误</li>-->
...
<!--              <ol>-->
<!--                <li>Add在线用户管理</li>-->
<!--                <li>Add按钮组功能实现（批量删除、导出、清空）</li>-->
<!--                <li>Add查询条件重置按钮</li>-->
<!--                <li>AddSwagger全局Token配置</li>-->
<!--                <li>Add后端参数校验</li>-->
<!--                <li>修复字典管理页面的日期查询异常</li>-->
<!--                <li>Update时间函数命名防止冲突</li>-->
